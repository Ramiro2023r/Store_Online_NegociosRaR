...
<div class="max-w-md mx-auto px-4 py-16">
    ...
    <form action="{{ route('register') }}" method="POST" class="bg-white border rounded-xl p-6 space-y-4">
        ...
        <div class="relative my-4">
            ...
            <div class="relative flex justify-center text-sm"><span class="bg-white px-3 text-gray-400">O regístrate con</span></div>
        </div>
        ...
        <p class="text-center text-sm text-gray-500 mt-4">¿Ya tienes cuenta? <a href="{{ route('login') }}" class="text-rar-600 font-semibold hover:underline">Inicia sesión</a></p>
    </form>
</div>
@endsection
